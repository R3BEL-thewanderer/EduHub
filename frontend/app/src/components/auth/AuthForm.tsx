...
export function AuthForm({ mode }: AuthFormProps) {
  ...
  const handleGoogleAuth = async () => {
    ...
    // Google OAuth will redirect — no need to navigate manually
  };
    ...
    >
      <div className="bg-white rounded-2xl border border-border p-8 shadow-lg">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            {isLogin 
              ...
              : 'Join thousands of EduHub students'}
          </p>
        </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-secondary border-border text-primary placeholder:text-muted-foreground/50"
                  required={!isLogin}
                />
              </div>
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-10 bg-secondary border-border text-primary placeholder:text-muted-foreground/50"
                required
              />
              <button
                type="button"
        ...
        <Button
          ...
          className="w-full border-border text-primary hover:bg-secondary"
          disabled={isLoading}
        >
        ...
        {!isLogin && (
          <p className="text-center text-muted-foreground text-xs mt-4">
            ...
            <Link to="/terms" className="text-sage hover:underline">Terms of Service</Link>
            {' '}and{' '}
            <Link to="/privacy-policy" className="text-sage hover:underline">Privacy Policy</Link>
          </p>
        )}
      </div>
    </motion.div>
